...
namespace Web_API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, RoomService roomService)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                {
                    await context.Response.WriteAsync(roomService.GetSettings());
                });
